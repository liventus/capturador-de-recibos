...
class ScannerVinActivity : AppCompatActivity() {

    private lateinit var previewView: PreviewView
    private lateinit var btnStartCamera: LinearLayout
    private lateinit var tvDetectedVin: TextView
    private lateinit var viewfinder: View

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_scanner_vin)

        previewView = findViewById(R.id.previewView)
        btnStartCamera = findViewById(R.id.btnStartCamera)
        tvDetectedVin = findViewById(R.id.tvDetectedVin)
